...
rh.consts('DEFAULT_TOPIC', encodeURI("#Introduction.htm".substring(1)));
rh.consts('HOME_FILEPATH', encodeURI("index.htm"));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', '258AE6F3-6F86-459E-A114-203EFD2F12AB' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "Deluxe Avails");
